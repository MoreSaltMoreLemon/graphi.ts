"use strict";
class Graphi {
    constructor(canvas, theme = "default", gridPercentX = .9, gridPercentY = .9, maxX = 30, maxY = 30, minX = 30, minY = 30) {
        this.canvas = canvas;
...
function graphCoord(canvas, globalCoordFn, percentX, percentY) {
    return function (coord) {
...
function gridCoord(graphCoordFn, maxX, maxY, minX, minY) {
    return function (coord) {
